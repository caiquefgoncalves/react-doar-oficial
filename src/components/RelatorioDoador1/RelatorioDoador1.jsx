// src/components/RelatorioDoador1/RelatorioDoador1.jsx
import { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import css from "./RelatorioDoador1.module.css";
...
export default function RelatorioDoador1({ api }) {
    const api_url = api;
    ...
    async function baixarRelatorio() {
        ...
        try {
            const token = localStorage.getItem('token');
            const url = `${api_url}/doador/meu_relatorio?token=${token}`;
            ...
            link.download = `relatorio_minhas_doacoes.pdf`;
                ...
                <div className={css.relatoriosContainer}>
                    <div className={css.itemRelatorio}>
                        <div className={css.itemInfo}>
                            <h3 className={css.itemTitulo}>Minhas Doações</h3>
                        </div>
